...
function generateEmailAuthenticationToken(email, firstName) {
    const payload = { email: email, firstName: firstName}
...
*/
function validateEmailAuthenticationToken(token) {
    try {
...
exports.validateEmailAuthenticationToken = validateEmailAuthenticationToken
